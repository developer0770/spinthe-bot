...
/**
 * Зелёная бутылочка — SVG-спрайт.
 * В этой MVP-версии используем встроенный SVG классической зелёной бутылки.
 * В будущем скины будут грузиться из /bottles/.
 */
export default function Bottle({ rotation = 0, onClick, isSpinning = false, size = 140 }: BottleProps) {
  return (
    <motion.div
      onClick={onClick}
